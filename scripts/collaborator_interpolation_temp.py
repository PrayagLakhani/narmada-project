...
station_folder = f"{DATA_BASE_URL}/collaborator/{collab_id}/display/temp"
narmada_geojson = f"{DATA_BASE_URL}/admin/display/geojson/narmada.geojson"
output_folder = f"{DATA_BASE_URL}/collaborator/{collab_id}/display/temp/output_temp_rasters"
