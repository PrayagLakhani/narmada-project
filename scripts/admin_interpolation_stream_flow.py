...
csv_dir = os.path.join(BASE_DATA, "admin", "display", "streamflow")
buffer_dir = os.path.join(BASE_DATA, "admin", "display", "shp")
output_folder = os.path.join(BASE_DATA, "admin", "display", "streamflow", "output_streamflow_rasters")
...
def _local_buffer_shapefile():
    return os.path.join(buffer_dir, "narmada_buffer_1000m.shp")
