...
for role in roles:
    for ufile in ufiles:
        path = os.path.join(dirname, f"template/{role}/{ufile}")
        print("Checking", path)
        ...
        body_start = r'<body class="bg-gradient-to-br from-brand-700 to-brand-400 min-h-[100vh] font-sans text-slate-800 m-0">\n'
